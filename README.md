...
This version can save scouting submissions to a hosted Supabase table first and fall back to QR if the cloud request fails.
...
```sql
create table public.scouting_submissions (
